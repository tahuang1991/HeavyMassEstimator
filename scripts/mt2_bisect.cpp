...
//double generatearray(double m, double px, double py){ 
//      double p[3]= {m, px, py};
//      //return p;
//      cout <<" m "<< m <<" px "<< px <<" py "<< py << endl;
//      return m;
//}
//
...
void mt2::set_momenta(double ma0, double pxa0, double pya0, 
      double mb0, double pxb0, double pyb0,
      double mmiss0, double pxmiss0, double pymiss0)
{
   double pa0[3] = {ma0, pxa0, pya0};
   double pb0[3] = {mb0, pxb0, pyb0};
   double pmiss0[3] = {mmiss0, pxmiss0, pymiss0};
